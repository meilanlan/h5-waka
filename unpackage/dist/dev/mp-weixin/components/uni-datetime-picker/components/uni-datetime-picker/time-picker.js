...
const _sfc_main = {
  ...
  watch: {
    modelValue: {
      handler(newVal) {
        if (newVal) {
          this.parseValue(components_uniDatetimePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal));
          this.initTime(false);
        } else {
          this.time = "";
    ...
    start: {
      handler(newVal) {
        this.parseDatetimeRange(components_uniDatetimePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal), "start");
      },
      immediate: true
    },
    end: {
      handler(newVal) {
        this.parseDatetimeRange(components_uniDatetimePicker_components_uniDatetimePicker_util.fixIosDateFormat(newVal), "end");
      },
      immediate: true
    },
  ...
  methods: {
    ...
    initTimePicker() {
      if (this.disabled)
        return;
      const value = components_uniDatetimePicker_components_uniDatetimePicker_util.fixIosDateFormat(this.time);
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/components/uni-datetime-picker/components/uni-datetime-picker/time-picker.js.map
