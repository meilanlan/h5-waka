...
const { t } = common_vendor.initVueI18n(components_uniDatetimePicker_components_uniDatetimePicker_i18n_index.i18nMessages);
const _sfc_main = {
  components: {
    calendarItem,
    timePicker
  ...
  created() {
    this.cale = new components_uniDatetimePicker_components_uniDatetimePicker_util.Calendar({
    ...
    init(date) {
      ...
      if (!date) {
        ...
        if (this.defaultValue && !this.range) {
          ...
          const fullDate = components_uniDatetimePicker_components_uniDatetimePicker_util.getDate(defaultDate);
          ...
          this.time = components_uniDatetimePicker_components_uniDatetimePicker_util.getTime(defaultDate, this.hideSecond);
        }
      }
    },
    /**
    ...
    setEmit(name) {
      if (!this.range) {
        ...
        if (this.hasTime && !this.time) {
          this.time = components_uniDatetimePicker_components_uniDatetimePicker_util.getTime(/* @__PURE__ */ new Date(), this.hideSecond);
        }
      }
      let {
        year,
...
if (!Array) {
  ...
  (_component_calendar_item + _component_time_picker + _component_uni_icons)();
}
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/components/uni-datetime-picker/components/uni-datetime-picker/calendar.js.map
