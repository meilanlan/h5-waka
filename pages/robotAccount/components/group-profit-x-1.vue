...
<script setup>
  ...
  function toPage(type) {
    // 1:收益详情 2:去结算 3:去提现
    let url = type === 1 ? '/pages/income/profitDetail?show_title=0&group_id='+parentInfo.data.group_id : type === 2 ? '/pages/income/settlement?show_title=0' : '/pages/income/wathdrawal?show_title=0'
    uni.navigateTo({
    	url: url
    });
  }
